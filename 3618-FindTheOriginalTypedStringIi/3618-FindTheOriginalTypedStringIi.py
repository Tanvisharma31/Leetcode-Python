# Last updated: 02/03/2026, 13:56:42
...
#         # Step 1: Compute consecutive character group lengths
#         consecutive = []
#         count = 1
...
#         n_groups = len(consecutive)

#         # Step 2: Product of all group lengths (total full combinations)
#         total_combinations = 1
#         for length in consecutive:
#             total_combinations = (total_combinations * length) % MOD

#         # Step 3: Determine how many optional presses are allowed
#         # Each group contributes one mandatory character
#         extra_chars = k - n_groups
#         if extra_chars <= 0:
#             return total_combinations

#         # Step 4: DP to count invalid combinations (where total length < k)
#         dp = [0] * extra_chars
#         dp[0] = 1
...
#                 if i + group < extra_chars:
#                     new_dp[i + group] = (new_dp[i + group] - dp[i]) % MOD
